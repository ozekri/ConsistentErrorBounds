"""
This file contains a Python implementation of the projection onto the exponential cone (and its dual).
This is the Python version of the Julia implementation of H. Friberg.
H. Friberg showed that finding the nearest mapping of a point onto these convex sets all reduce to a single univariate rootfinding problem.
"""
